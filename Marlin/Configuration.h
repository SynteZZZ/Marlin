...
#define STRING_CONFIG_H_AUTHOR "SynteZZZ" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  45.72
    #define DEFAULT_Ki  5.58
    #define DEFAULT_Kd  93.63
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 21.46
  #define DEFAULT_bedKi 3.97
  #define DEFAULT_bedKd 77.37
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 28, -2.4 } //!!! -2.3 if 100% flow
